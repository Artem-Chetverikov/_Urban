...
templates = Jinja2Templates(directory=Path_file(__file__).parent / "templates")
...
async def root_adm(request: Request, user_id: int) -> HTMLResponse:
...
# python -m uvicorn 1.module_16_5.module_16_5:app --reload
